...
#define LOG_EVENT_TYPES_26 (INCIDENT_EVENT)
#define LOG_EVENT_TYPES_27 (HEARTBEAT_EVENT)
#define LOG_EVENT_TYPES_MAX (ENUM_END_EVENT-1)
...
#define FORMAT_DESCRIPTION_HEADER_LEN (START_V3_HEADER_LEN + 1 + LOG_EVENT_TYPES_MAX)
